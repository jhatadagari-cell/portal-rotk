...
const HacBuild = (function () {
  ...
  const CONSTRUCCIONES = Object.freeze([
    ...
    { id: 'mercado', dominio: 'administrativo',    nombre: 'Mercado',            zh: '市',   capa: 'edificio', footprint: [2, 2], tierMin: 2, unico: false, cargoMin: null, color: '#b8863a', altura: 26, desc: 'Puesto de mercado con su mercader: aquí los mecenas gastan el dinero ganado en misiones (artículos por tiers).' },
    ...
    { id: 'salon-trono',     dominio: 'administrativo', nombre: 'Salón del Trono',   zh: '太極殿', capa: 'edificio', footprint: [9, 12], tierMin: 5, unico: true,  cargoMin: null, color: '#c43c1a', altura: 88, desc: 'El gran salón del trono imperial: la construcción más imponente del eje.' },
