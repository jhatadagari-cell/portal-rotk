...
const HacTienda = (function () {
  ...
  const CATALOGO = Object.freeze([
    ...
    { id: 'recompensa-semanal', nombre: 'Recompensa semanal', zh: '恩賞', icon: '🎁', tier: 99, oculto: true, tipo: 'recompensa', donable: false, efecto: { guardable: true, recompensaSemanal: true }, desc: 'Un presente de tu señor por cumplir los retos de la semana. Ábrelo para ganar XP en tus tres aptitudes —cuanto mayor el edificio principal de la casa, mayor la recompensa (del +10% al +30%)— o guárdalo.' },
    ...
    //   azul. Cada una tiene SELLO VISUAL propio (`viste.gala`, cf. galaSello de
    //   hac-char): la del General es una CORAZA laminada de gala (kind 'armor' →
    //   incluye casco con penacho); las demás son túnicas con su rasgo distintivo.
    //   Caen como botín RARO (ROPA_RARA_LOOT_CHANCE ~5%); no se compran.
    { id: 'ropa-mil-r', nombre: 'Casaca del General',        zh: '名將袍', icon: '👘', tier: 4, tipo: 'equipo', slot: 'torso', raro: true, oculto: true, precio: 180,
      efecto: { equip: { pct: { militar: 0.10 }, prestigioPct: 0.05, antirroboPct: 0.20 } }, viste: { kind: 'armor', torsoGala: true, gala: 'general', robe: '#7a2620', accent: '#d8b65a' }, desc: 'Coraza de parada de un gran general: láminas ribeteadas en oro, espejo pectoral y casco de penacho escarlata. +10% Militar 武, +5% prestigio y 20% antirrobo. (Rara)' },
    { id: 'ropa-cul-r', nombre: 'Túnica del Gran Erudito',   zh: '鴻儒袍', icon: '👘', tier: 4, tipo: 'equipo', slot: 'torso', raro: true, oculto: true, precio: 180,
      efecto: { equip: { pct: { cultural: 0.10 }, prestigioPct: 0.05, antirroboPct: 0.20 } }, viste: { kind: 'robe', torsoLujo: true, torsoGala: true, gala: 'erudito', robe: '#24506a', accent: '#bfe0d8' }, desc: 'Túnica ceremonial de un sabio insigne, con colgante de jade al cinto y nubes bordadas. +10% Cultural 文, +5% prestigio y 20% antirrobo. (Rara)' },
    { id: 'ropa-adm-r', nombre: 'Toga del Ministro',         zh: '相國袍', icon: '👘', tier: 4, tipo: 'equipo', slot: 'torso', raro: true, oculto: true, precio: 180,
      efecto: { equip: { pct: { administrativo: 0.10 }, prestigioPct: 0.05, antirroboPct: 0.20 } }, viste: { kind: 'robe', torsoLujo: true, torsoGala: true, gala: 'ministro', robe: '#1f4433', accent: '#d8b65a' }, desc: 'Toga de un ministro de la corte, con cinturón de placas de jade y cordón escarlata del cargo. +10% Administrativo 政, +5% prestigio y 20% antirrobo. (Rara)' },
    { id: 'ropa-mc-r',  nombre: 'Manto del Gran Estratega',  zh: '臥龍袍', icon: '👘', tier: 5, tipo: 'equipo', slot: 'torso', raro: true, oculto: true, precio: 220,
      efecto: { equip: { pct: { militar: 0.05, cultural: 0.05 }, prestigioPct: 0.05, antirroboPct: 0.20 } }, viste: { kind: 'robe', torsoLujo: true, torsoGala: true, gala: 'estratega', robe: '#3f4468', accent: '#e7e0cc' }, desc: 'Manto del genio que domina armas y letras, con esclavina de viaje y el trigrama ☰ a la espalda. +5% Militar 武, +5% Cultural 文, +5% prestigio y 20% antirrobo. (Rara)' },
    { id: 'ropa-ca-r',  nombre: 'Vestidura del Preceptor',   zh: '太傅袍', icon: '👘', tier: 5, tipo: 'equipo', slot: 'torso', raro: true, oculto: true, precio: 220,
      efecto: { equip: { pct: { cultural: 0.05, administrativo: 0.05 }, prestigioPct: 0.05, antirroboPct: 0.20 } }, viste: { kind: 'robe', torsoLujo: true, torsoGala: true, gala: 'preceptor', robe: '#4a2170', accent: '#e6c66a' }, desc: 'Vestidura del preceptor imperial: cuello de nubes dorado, medallón de jade y brocado en el bajo. +5% Cultural 文, +5% Administrativo 政, +5% prestigio y 20% antirrobo. (Rara)' },
